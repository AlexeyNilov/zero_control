...
> **As a** device owner, **I want** to send commands to the device through Telegram bot **so that** I can control it remotely from a familiar interface.
...
> **As a** developer, **I want** project decisions and requirements to be documented as the work evolves **so that** I can learn from the process and avoid rediscovering earlier reasoning.
